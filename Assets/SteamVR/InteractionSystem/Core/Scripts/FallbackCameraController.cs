...
namespace Valve.VR.InteractionSystem
{
	...
	public class FallbackCameraController : MonoBehaviour
	{
		...
		private NetworkBehaviour networker;
		...
		void OnEnable()
		{
			...
			//print();
			foreach (NetworkBehaviour script in GetComponentsInParent<NetworkBehaviour>()) {
				print(script);
			}
			networker = GetComponentsInParent<NetworkBehaviour>()[0];
		}
